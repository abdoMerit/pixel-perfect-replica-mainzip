...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Unique Future Foundation (UFF)" },
      { name: "description", content: "Unique Future Foundation (UFF) is a non-profit organization building sustainable programs in education, health, environment, and livelihood across communities." },
      { property: "og:title", content: "Unique Future Foundation (UFF)" },
      { property: "og:description", content: "Unique Future Foundation (UFF) is a non-profit organization building sustainable programs in education, health, environment, and livelihood across communities." },
